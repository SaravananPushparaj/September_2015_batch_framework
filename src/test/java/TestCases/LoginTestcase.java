...
public class LoginTestcase {
	...
	@Test(dataProvider = "DP_validlogin",dataProviderClass =DataProvider.DP_Login.class,groups={"SmokeTest","RegressionTest"} )
	...
	@Test(dataProvider = "Invalid_Login_DP",dataProviderClass =DataProvider.DP_Login.class, groups={"RegressionTest"}) 
