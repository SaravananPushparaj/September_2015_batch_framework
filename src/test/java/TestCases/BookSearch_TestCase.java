...
public class BookSearch_TestCase {
	...
	@Test(dataProvider = "Valid_booksearch_DP" ,dataProviderClass =DataProvider.DP_BookSearch.class, groups={"SmokeTest","RegressionTest"})
	...
	//**********************************************
	@Test(dataProvider = "Invalid_booksearch_DP",dataProviderClass = DataProvider.DP_BookSearch.class, groups={"RegressionTest"})
